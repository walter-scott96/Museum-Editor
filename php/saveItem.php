...
<?php
    ...
    if(isset($_POST['name']) && isset($_POST['description']) && isset($_POST['category']))
    {
        ...
        if(isset($_FILES['file-0']['name']))
        {
            ...
            {
                //Query to be made on the database
                $query .= "INSERT INTO `item`(`name`, `description`, `category`) VALUES ('$name','$description', '$category'); INSERT INTO `image`(`filename`, `isThumbnail`,`iname`) VALUES ";
                ...
                {
                    $query .= " INSERT INTO `image`(`filename`, `isThumbnail`,`iname`) VALUES ('$uploadedThumbnail', 1, '$name');";
                }
        ...
        {
            //Query to be made on the database
            $query .= "INSERT INTO `item`(`name`, `description`, `category`) VALUES ('$name','$description', '$category');";
